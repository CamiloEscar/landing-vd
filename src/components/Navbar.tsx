...
import { Menu, X, Tv, Wifi, Home, Users, CreditCard, MapPin, Phone, MessageCircle } from 'lucide-react';
          ...
          >
            <div className="flex-shrink-0 flex items-center gap-x-3">
              ...
              <div className={`font-bold transition-colors duration-300 ${
                ...
                <div className="text-xs text-blue-500 font-medium">Internet & Cable</div>
              </div>
            </div>
          </motion.div>
